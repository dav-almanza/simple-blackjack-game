   ...
   */
 export const puntosYcartasHTmL = ( deck, turno, puntos, smalls, divCartasImg ) => {
    ...
    // HTmL
    smalls[turno].querySelector('small').textContent = puntos[turno];
    // smalls[turno].innerHTML = `
    //     <p class="active-player">It's your turn!</p>
    //     <h2> ${jugador[turno]}: <small> ${puntos[turno]} </small> </h2> 
    //     `;
